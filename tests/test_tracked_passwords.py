# -*- coding=utf-8 -*-
r"""
Tests for the tracked_passwords module — core functionality.
...
Design principles:
  ...
  - Where fixed strings are used, pair them with random-data counterparts
    that test the same invariant.
